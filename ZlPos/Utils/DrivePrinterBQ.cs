            ...
            try
            {
                ...
                while (_PrintQueue.Peek() != null)
                {
                    ...
                    if (line.isBarCode == 1 && !string.IsNullOrEmpty(line.text))
                    {
                        ...
                        g.DrawImage(CreateBarcodePicture(line.text, 50, 32), float.Parse(line.directionX) * 4, float.Parse(line.directionY) * 4);
                    }
                    else
                    {
                        ...
                        g.DrawString(line.text, printFont, myBrush, float.Parse(line.directionX) * 4, float.Parse(line.directionY) * 4, new StringFormat());
                    }
